...
VIEW            | 
MainView        | Реализует интерфейс отображения и обновления слайдера в браузере. Является пассивным. Не знает о существовании `model`
PathView        | Хранит инстансы ползунков и обрабатывает их события. Отвечает за отображение и обновление слайдера. Диспатчит события перемещения одного из ползунков.
